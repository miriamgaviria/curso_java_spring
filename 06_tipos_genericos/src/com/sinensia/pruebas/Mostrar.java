...
public class Mostrar {
    ...
    public static void mostrando(){
        ...
        */
        ...
        Cliente clienteAna = mapaClientes.get("01");
        ...
        for (Map.Entry<String, Cliente> parClaveValor : mapaClientes.entrySet()){
            ...
            if (cliente instanceof ClienteInvitado){
                //ClienteInvitado clienteInv = (ClienteInvitado) valor;
                //clienteInv.setDuracionMax(clienteInv.getDuracionMax()+8);
                ((ClienteInvitado) cliente).setDuracionMax(((ClienteInvitado) cliente).getDuracionMax()+8);
