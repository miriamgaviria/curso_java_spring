...
public class ControladorClientes extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ServicioClientes serviCli;
        serviCli = new ServicioClientes();
        Cliente cli = serviCli.insertar(nombre, email, password, edad, activo);
        if (cli == null){
            request.getRequestDispatcher("error_registro.jsp").forward(request, response);
        }else{
            request.getRequestDispatcher("ok_registro.jsp").forward(request, response);
        }
