...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`cliente` (`id`, `nombre`, `email`, `edad`, `password`, `activo`) VALUES (DEFAULT, 'Prueba', 'prueba@gmal.com', 20, '123', 0);
...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`producto` (`id`, `nombre`, `precio`, `cantidad`) VALUES (DEFAULT, 'Prueba', 1, '1');
